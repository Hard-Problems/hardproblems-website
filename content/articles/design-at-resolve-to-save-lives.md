...
What does a design team at a public health NGO do? Hard Problems' [Daniel Burka](/authors/daniel-burka) interviewed [Tony Joy](https://www.linkedin.com/in/tony-joy/), senior product designer, and their design and product team.
...
![A health worker in a clinic entering a patient's blood pressure into the Simple app on a phone, surrounded by paper registers and red Simple patient cards](/images/content/article-simple-user.jpg){.normal-width}
_A healthcare worker using the [Simple](https://simple.org) app to manage patients with hypertension._{.caption}
...
![The HEARTS 360 hypertension dashboard for River District, showing 4,808 patients with blood pressure under control, a treatment cascade from 250,800 estimated people with hypertension down to those controlled, and treatment-outcome charts](/images/content/article-hearts-360.png)
_The [HEARTS360](https://hearts360.org) dashboard made by the design team at Resolve to Save Lives is an example dashboard for managing chronic disease programs_{.caption}
...
![Tony and a colleague at a health clinic in Yogyakarta, Indonesia, observing health workers entering patient records on a laptop while another team member assists a patient](/images/content/photo-resolve-to-save-lives.jpg){.normal-width}
_Tony and Chetan working with healthcare workers in Indonesia to create an electronic health record for chronic disease management that fits into their workflows._{.caption}
...
![Sketch of a designer sitting with a nurse in a clinic, watching her use an app: "Should I click on this button?" "What do you think? I'm trying to see what you'd do in a real clinic."](/images/content/resolve-to-save-lives-sketch.jpg){.normal-width}
